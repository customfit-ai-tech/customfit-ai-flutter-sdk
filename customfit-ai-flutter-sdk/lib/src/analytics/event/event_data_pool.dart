...
class EventDataPool {
  ...
  static const int _maxPoolSize =
      100; // CFConstants.objectPool.maxEventDataPoolSize

  /// Minimum pool size to maintain ready instances
  static const int _minPoolSize =
      10; // CFConstants.objectPool.minEventDataPoolSize
  ...
  static const int _maxStringCacheSize =
      1000; // CFConstants.objectPool.maxStringCacheSize
