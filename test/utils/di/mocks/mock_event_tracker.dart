...
class MockEventTracker implements EventTracker {
  ...
  // Required getters from EventTracker
  @override
  bool get isEmpty => _events.isEmpty;
  
  @override
  int get queueSize => _events.length;
  
  @override
  int get totalEventsDropped => _droppedEvents.length;
  ...
  @override
  int getPendingEventsCount() => _events.length;
