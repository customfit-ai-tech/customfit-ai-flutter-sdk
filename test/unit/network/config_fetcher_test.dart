...
import 'package:customfit_ai_flutter_sdk/src/infrastructure/network/internal/config_fetcher_impl.dart';
...
void main() {
  ...
  group('ConfigFetcher Unit Tests', () {
    late ConfigFetcherImpl configFetcher;
    ...
    setUp(() async {
      ...
      await CacheManagerImpl.instance.clear();
      ...
      // Create UserManager with the user
      userManager = UserManagerImpl(user);
      // Create mock HTTP client
      mockHttpClient = MockHttpClient();
      mockHttpClient.reset();
      // Create ConfigFetcher instance with UserManager
      configFetcher = ConfigFetcherImpl(mockHttpClient, config, userManager);
    });
    tearDown(() async {
      await CacheManagerImpl.instance.clear();
      mockHttpClient.reset();
