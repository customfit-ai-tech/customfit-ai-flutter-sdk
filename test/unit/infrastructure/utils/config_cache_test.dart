...
import 'package:customfit_ai_flutter_sdk/src/infrastructure/storage/internal/config_cache.dart';
...
void main() {
  ...
  group('ConfigCache Comprehensive Tests', () {
    ...
    group('1. Cache Policy & TTL Management', () {
      test('should cache config with default policy (5 minutes TTL)', () async {
        // Arrange
        final configMap = {
        ...
        // Verify metadata was stored with correct TTL (5 minutes)
        ...
        expect(ttlMs, 300 * 1000); // 5 minutes in milliseconds
      });
