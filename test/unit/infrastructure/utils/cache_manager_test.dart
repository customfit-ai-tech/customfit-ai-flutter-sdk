...
import 'package:customfit_ai_flutter_sdk/src/infrastructure/storage/internal/preferences_service_impl.dart';
import 'package:customfit_ai_flutter_sdk/src/infrastructure/storage/internal/cache_manager_impl.dart';
import 'package:customfit_ai_flutter_sdk/src/infrastructure/storage/interfaces/cache_manager.dart';
import 'package:customfit_ai_flutter_sdk/src/infrastructure/utils/type_conversion_strategy.dart';
import 'package:customfit_ai_flutter_sdk/src/infrastructure/logging/logger.dart';
...
void main() {
  ...
  group('CacheManager Comprehensive Tests', () {
    ...
    setUp(() async {
      ...
      PreferencesService.reset();
      CacheManagerImpl.clearTestInstance();
      // Get the cache manager instance
      cacheManager = CacheManagerImpl.instance;
    ...
    group('9. Static Methods and Instance Management', () {
      test('should test static setTestInstance and clearTestInstance', () {
        final testCacheManager = CacheManagerImpl.instance;
        CacheManagerImpl.setTestInstance(testCacheManager);
        expect(CacheManagerImpl.instance, same(testCacheManager));
        CacheManagerImpl.clearTestInstance();
      });
      test('should handle cache initialization errors', () async {
        final prefs = await SharedPreferences.getInstance();
        await prefs.setString('cf_cache_meta', 'invalid_json');
        final newCacheManager = CacheManagerImpl.instance;
