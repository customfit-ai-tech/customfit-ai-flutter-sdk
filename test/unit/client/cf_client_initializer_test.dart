...
import 'package:customfit_ai_flutter_sdk/src/infrastructure/storage/internal/preferences_service_impl.dart' as prefs;
...
void main() {
  ...
  group('CFClientInitializer', () {
    ...
    late MockIBackgroundStateMonitor mockBackgroundStateMonitor;
    ...
    setUp(() {
      ...
      mockBackgroundStateMonitor = MockIBackgroundStateMonitor();
      mockSessionManager = MockSessionManager();
      TestConfig.setupTestLogger();
      prefs.PreferencesService.reset();
