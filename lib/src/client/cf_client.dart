...
import '../infrastructure/di/internal/dependency_container.dart';
import '../infrastructure/network/internal/connection_manager_impl.dart';
import '../infrastructure/logging/log_level_updater.dart';
...
class CFClient {
  ...
  static void clearInstance() {
    ...
    prefs_impl.PreferencesService.reset();
  }
  ...
  Future<void> shutdown() async {
    ...
    if (_sessionManager != null) {
      await _sessionManager!.shutdown();
    }
  ...
  /// ```
  void clearGracefulDegradationCache() {
    _featureFlagsComponent.clearDegradationCache();
  }
  ...
  void clearFlagCache(String key) {
    _featureFlagsComponent.clearFlagCache(key);
  }
  ...
  Map<String, dynamic> getCacheStats() {
    return _featureFlagsComponent.getCacheStats();
  }
