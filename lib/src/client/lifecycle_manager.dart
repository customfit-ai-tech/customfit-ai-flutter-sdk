...
class LifecycleManager {
  ...
  void _initialize() {
    try {
      ...
      _backgroundStateMonitor.addAppStateListener(onAppStateChanged);
  ...
  void onAppStateChanged(AppState newState) {
    try {
      ...
      if (_currentAppState == AppState.background &&
        ...
        _onAppBackground();
      } else if (newState == AppState.background) {
        // App is terminating
        _onAppTerminate();
      }
  ...
  void shutdown() {
    try {
      ...
      _backgroundStateMonitor.removeAppStateListener(onAppStateChanged);
