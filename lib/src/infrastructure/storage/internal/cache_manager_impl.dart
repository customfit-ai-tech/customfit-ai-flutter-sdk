...
import '../../utils/synchronization.dart';
import '../../utils/type_conversion_strategy.dart';
...
// CachePolicy now imported from interfaces/cache_manager.dart

/// CacheManagerImpl provides persistent caching for configurations with TTL
class CacheManagerImpl {
  ...
  static CacheManagerImpl? _testInstance;

  // Private constructor
  CacheManagerImpl._();

  /// Get the singleton instance
  static CacheManagerImpl get instance {
    // Return test instance if set (for unit testing)
    if (_testInstance != null) {
      return _testInstance!;
    }
    _instance ??= CacheManagerImpl._();
    return _instance!;
  }

  /// Set a test instance for unit testing
  static void setTestInstance(CacheManagerImpl testInstance) {
  ...
  Future<bool> put<T>(
    ...
    try {
      ...
      // Note: Cache size tracking simplified
