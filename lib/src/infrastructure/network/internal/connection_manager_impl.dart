// infrastructure/network/internal/connection_manager_impl.dart
//
// Implementation of connection manager interface for the CustomFit SDK.
// Manages reconnect logic and notifies listeners of connection status changes.
...
/// Implementation of connection manager interface
class ConnectionManagerImpl
    implements IConnectionManager, IConnectionStatusListener {
  // ignore: unused_field
  final CFConfig _config;
  final List<IConnectionStatusListener> _listeners = [];
  ...
  void onConnectionStatusChanged(
    ...
    // This method implements IConnectionStatusListener
    // When ConnectionManagerImpl receives status changes, it can update internal state
    Logger.d('ConnectionManagerImpl received status change: $newStatus');
  }
...
class _BasicConnectionStatusListener implements IConnectionStatusListener {
